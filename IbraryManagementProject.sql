...
references publisher(publisher_PublisherName))auto_increment=1;
...
references books(book_BookID))auto_increment=1;
...
references library_branch(library_branch_BranchID))auto_increment=1;
